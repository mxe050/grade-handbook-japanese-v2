...
path = r'c:\Users\yuasa\.gemini\antigravity\scratch\grade-handbook-japanese-v2\index.html'

with open(path, 'r', encoding='utf-8') as f:
    content = f.read()

# Tab 1 Content Chapter 7
tab1_content = """<div class="card">
...
# Tab 2 Content Chapter 7
tab2_content = """<div class="card flow-chart-card">
...
p1 = r'<div class="placeholder-msg">.*?<h3>CoreGrade解説</h3>.*?</div>'
p2 = r'<div class="placeholder-msg">.*?<h3>CoreGRADEフローチャート</h3>.*?</div>'

# Replace only the first occurrence (Chapter 7)
new_content = re.sub(p1, tab1_content, content, count=1, flags=re.DOTALL)
new_content = re.sub(p2, tab2_content, new_content, count=1, flags=re.DOTALL)

with open(path, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Successfully updated Chapter 7 placeholders.")
