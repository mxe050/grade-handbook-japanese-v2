...
# Read with no encoding to preserve whatever is there, then treat as string
$content = [System.IO.File]::ReadAllText($path)

# Flexible Regex for Tab 1
$placeholder1 = '(?s)<div class="placeholder-msg">\s*<i>.*?</i>\s*<h3>CoreGrade解説</h3>\s*<p>.*?</p>\s*</div>'
$newContent1 = @'
<div class="card">
...
# Flexible Regex for Tab 2
$placeholder2 = '(?s)<div class="placeholder-msg">\s*<i>.*?</i>\s*<h3>CoreGRADEフローチャート</h3>\s*<p>.*?</p>\s*</div>'
$newContent2 = @'
...
$content = [regex]::Replace($content, $placeholder1, $newContent1, 1)
$content = [regex]::Replace($content, $placeholder2, $newContent2, 1)
