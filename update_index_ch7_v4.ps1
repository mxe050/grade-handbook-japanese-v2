...
for ($i = 0; $i -lt $lines.Count; $i++) {
    # Replace Tab 1 (Line 1734-1738) -> index 1733 to 1737
    if ($i -eq 1733) {
        foreach ($line in $tab1) { $newLines.Add($line) }
        $i = 1737
    }
    # Replace Tab 2 (Line 1741-1745) -> index 1740 to 1744
    elseif ($i -eq 1740) {
        foreach ($line in $tab2) { $newLines.Add($line) }
        $i = 1744
    }
    else {
